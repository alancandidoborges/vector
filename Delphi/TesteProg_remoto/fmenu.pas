...
uses fcadforn, fcadprod, frelfopr, frlfopr, FMENURLFOPR;
...
begin
  if application.FindComponent('F_MENU_RL_FOPR') = nil then
    Application.CreateForm(TF_MENU_RL_FOPR, F_MENU_RL_FOPR);
  try
    F_MENU_RL_FOPR.ShowModal;
  finally
    F_MENU_RL_FOPR.Free;
  end;
end;
